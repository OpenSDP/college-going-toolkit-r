...
If you are using the synthetic data we have provided (available for download at
[sdp.cepr.harvard.edu/toolkit](www.sdp.cepr.harvard.edu/toolkit)), the sample
restrictions have been predefined and are included on the next page.
...
about the SPIs at [sdp.cepr.harvard.edu/spi](http://sdp.cepr.harvard.edu/spi).
...
## Task 3: Progression by Student Race/Ethnicity, Among FRPL Students
...
## Task 1 Proportion of Students On-Track by High School
...
## Task 6: Gaps in Rates of College Enrollment Between Latino and White Graduates
