...
All variables in an R dataframe should be labeled (as should database columns). 
...
copy/paste. Alternatively, call upon a separate .R file in your main code that 
contains a function to apply standard labels rather than including labeling code
in your primary .R script.
